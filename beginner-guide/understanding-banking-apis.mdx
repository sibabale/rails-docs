...
const response = await fetch('https://api.railsinfra.com/v1/accounts/12345/balance', {
  headers: {
...
const response = await fetch('https://api.railsinfra.com/v1/transfers', {
  method: 'POST',
  headers: {
    'Content-Type': 'application/json',
    'Authorization': 'Bearer your-rails-token'
...
const response = await fetch('https://api.railsinfra.com/v1/customers', {
  method: 'POST',
  headers: {
    'Content-Type': 'application/json',
...
const apiUrl = 'https://api.railsinfra.com/v1/accounts'; // Always HTTPS
