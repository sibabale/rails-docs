...
api: "GET https://api.railsinfra.com/api/v1/transactions/{id}"
...
const transaction = await rails.transactions.retrieve("abc12345-e89b-12d3-a456-426614174000");
...
```go Go
transaction, err := client.Transactions.Retrieve(ctx, "abc12345-e89b-12d3-a456-426614174000")
```

```java Java
var transaction = client.transactions().retrieve("abc12345-e89b-12d3-a456-426614174000");
```

```kotlin Kotlin
val transaction = client.transactions.retrieve("abc12345-e89b-12d3-a456-426614174000")
```

```csharp C#
var transaction = await client.Transactions.RetrieveAsync("abc12345-e89b-12d3-a456-426614174000");
```
